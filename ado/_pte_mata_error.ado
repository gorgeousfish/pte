...
program define _pte_mata_error
    ...
    if "`errcode'" == "601" {
        ...
        di as error "    1. Reinstall pte: ssc install pte, replace"
        ...
        di as error "    3. Reinstall pte: ssc install pte, replace"
        di as error "    4. See: help _pte_mata_init"
    }
    else {
        // Unknown error code
        ...
        di as error "    2. Reinstall pte: ssc install pte, replace"
